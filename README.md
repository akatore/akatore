...
| **CI/CD with Terraform and Kubernetes**                                       | Implemented CI/CD pipelines to automate the deployment of applications on Google Cloud.                                    | - Designed and built CI/CD pipelines using Terraform and Kubernetes.<br>- Integrated application deployment processes.   | Terraform, Google Cloud, Kubernetes                                                                     | [View Project](https://github.com/akatore/GCP-projects/tree/main/ci-cd-with-terraform-kubernetes-on-gcp)                     |
